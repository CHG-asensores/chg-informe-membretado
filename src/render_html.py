...
def render_html(data, template_path, membrete_path):
    ...
    # Logo símbolo AV (tarjeta negra) — mismo directorio que membrete.png
    logo_av_path = Path(membrete_path).parent / "Logo_Word.png"
    logo_av_b64 = ""
    if logo_av_path.exists():
        with open(logo_av_path, "rb") as f:
            logo_av_b64 = base64.b64encode(f.read()).decode("utf-8")
    ...
    html_out = template.render(
        data=data,
        membrete_base64=membrete_b64,
        logo_av_b64=logo_av_b64,
    )
